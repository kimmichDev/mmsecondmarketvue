<template>
  <div class="container-fluid vh-100">
    <div class="row p-0">
      <div class="col-12 col-md-6 m-0 p-0 vh-30 vh-md-100 bg-primary d-flex flex-column justify-content-center align-items-center">
        <div class="w-25">
      ...
      <div class="col-12 col-md-6 vh-min-60 vh-md-100 d-flex justify-content-center align-items-center">
        <div>
          <p class="h5 my-4 fw-bold">အကောင့်ဖွင့်မည်</p>
          <form @submit.prevent="register">
            <small class="text-danger text-small" v-if="errors.name">{{ errors.name[0] }}</small>
            <div class="input-group shadow-sm mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="bi bi-person"></i></span>
              <input v-model="formData.name" type="text" :class="['form-control', { 'is-invalid': errors.name }]" placeholder="အမည်" aria-label="Username" aria-describedby="basic-addon1" />
            </div>

            <small class="text-danger text-small" v-if="errors.email">{{ errors.email[0] }}</small>
            <div class="input-group shadow-sm mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="bi bi-envelope"></i></span>
              <input v-model="formData.email" type="email" :class="['form-control', { 'is-invalid': errors.email }]" placeholder="အီးမေးလိပ်စာ" aria-label="Username" aria-describedby="basic-addon1" />
            </div>
            ...
            <div class="input-group shadow-sm mb-3">
              ...
              <input v-model="formData.phone" type="text" :class="['form-control', { 'is-invalid': errors.phone }]" placeholder="ဖုန်းနံပါတ် 09******" aria-label="Userphone" aria-describedby="basic-addon1" />
            </div>
            ...
            <div class="input-group shadow-sm mb-3">
              ...
              <input v-model="formData.address" type="text" :class="['form-control', { 'is-invalid': errors.address }]" placeholder="လိပ်စာ" aria-label="Username" aria-describedby="basic-addon1" />
            </div>

            <small class="text-danger text-small" v-if="errors.password">{{ errors.password[0] }}</small>
            <div class="input-group shadow-sm mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="bi bi-lock"></i></span>
              <input v-model="formData.password" type="password" :class="['form-control', { 'is-invalid': errors.password }]" placeholder="စကားဝှက်" aria-label="Username" aria-describedby="basic-addon1" />
            </div>

            <small class="text-danger text-small" v-if="errors.confirm_password">{{ errors.confirm_password[0] }}</small>
            <div class="input-group shadow-sm mb-3">
              <span class="input-group-text" id="basic-addon1"><i class="bi bi-lock-fill"></i></span>
              <input v-model="formData.confirm_password" type="password" :class="['form-control', { 'is-invalid': errors.confirm_password }]" placeholder="စကားဝှက်ထပ်မံရိုက်ထည့်ပါ" aria-label="Username" aria-describedby="basic-addon1" />
            </div>
            ...
            <button class="btn btn-primary w-100 text-light mb-3">
              အကောင့်ဖွင့်မည်
